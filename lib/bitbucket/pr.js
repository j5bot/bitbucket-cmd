...
define([
	...
	var pullrequest = {
		...
		list: function (options) {
			this.query = 'pullrequests?fields=%2Bvalues.reviewers.username,values.id,values.title,values.state,values.destination.branch.name,values.source.branch.name,values.author.username&pagelen=200';
			if (options.merged) {
