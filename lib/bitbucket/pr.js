...
define([
	...
	var pullrequest = {
		...
		list: function (options) {
			this.query = 'pullrequests?fields=%2Bvalues.reviewers.username,values.id,values.title,values.state,values.destination.branch.name,values.source.branch.name,values.author.username&sort=-updated_on&pagelen=15';
